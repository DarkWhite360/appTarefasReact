                        ...
                        tarefas.map((item) => (
                            <View key={item.id} style={estilo.itemLista}>
                                ...
                                <View style={estilo.acoes}>
                                    <TouchableOpacity style={estilo.botaoVerMais} onPress={() => navigation.navigate('ListarTarefa', { item })}>
                                        <Text style={estilo.textoBotao}>Ver Mais</Text>
                                    </TouchableOpacity >
                                    <TouchableOpacity style={estilo.botaoEditar} onPress={() => navigation.navigate('EditarTarefa', { item })}>

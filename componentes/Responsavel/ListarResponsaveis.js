                ...
                <ScrollView contentContainerStyle={estilo.listaResponsavel}>
                    {
                        responsaveis.map((item) => (
                            <View key ={item.id} style={estilo.itemLista}>
                                <Text style={estilo.responsavel}>Responsável: {item.nome}</Text>
                                ...
                                <View style={estilo.acoes}>
                                    ...
                                    <TouchableOpacity style={estilo.botaoVerMais} onPress={()=> navigation.navigate('ListarResponsavel' ,{item})}>
                                    ...
                                    <TouchableOpacity style={estilo.botaoExcluir} onPress={()=> navigation.navigate('ExcluirResponsavel' ,{item})}>
